...
tests = [ ("vpxenc --quiet --good -o ##OUTFILE## ##INFILE##", 1, vpxenc_server)
        #, ("##INSTATEWAIT## /home/username/git/github.com/excamera-anonymous/src/frontend/xc-enc -s ##QUALITY## -i y4m ##INSTATESWITCH## -O ##TMPDIR##/final.state -o ##OUTFILE## ##INFILE##", 2, xcenc_server)
        ]
